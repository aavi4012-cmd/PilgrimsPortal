...
export default function BookingPage() {
  ...
  return (
    <div className="min-h-screen pt-100 bg-gradient-to-br from-orange-50 to-teal-50 relative overflow-hidden">
      {/* <AnimatedBackground /> */}
      ...
      >
        <h1 className="text-4xl mt-1000 md:text-5xl font-bold text-gray-800 mb-4 font-cinzel">
